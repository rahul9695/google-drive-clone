...
const planArray = [
  ...
  },
  {
    ...
    price: "10",
    options:
      "100 GB of storage, Access to Google experts, Share with upto 5 others, Extra member benefits, More Google Photos editing features",
    priceId: "price_1OhdXSSA7D64cqxIcuDIsbWJ",
  },
];
