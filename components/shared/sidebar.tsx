...
const Sidebar = () => {
  ...
  const { subscription, isLoading, totalStorage, setTotalStorage } = useSubscription();
      ...
      <div className="flex flex-col p-3 pt-5">
        <Popover>
          <PopoverTrigger asChild>
            <Button className="w-fit h-12 rounded-full px-8 ml-3">
              <Plus />
              <span>New</span>
            </Button>
          </PopoverTrigger>
        ...
        <div className="flex flex-col space-y-6 mt-8">
          ...
          <div className="flex flex-col space-y-2 mx-4">
            ...
            <Button
              className="rounded-full hover:bg-black text dark:hover:bg-secondary hover:text-white transition"
              variant={"outline"}
              onClick={onOpen}
            >
              Get more storage
